...
@interface APPullToRefresh ()

@end

@implementation APPullToRefresh

@synthesize textPull, textRelease, textLoading, refreshHeaderView, refreshLabel, refreshSpinner, refreshArrow;
